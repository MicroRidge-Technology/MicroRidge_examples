...
struct dc_ram_dut{
	...
	sim_port_construct(data_a),
	sim_port_construct(data_b),
	sim_port_construct(addr_a),
	sim_port_construct(addr_b),
	sim_port_construct(we_a),
	sim_port_construct(we_b),
	sim_port_construct(clk_a),
	sim_port_construct(clk_b),
